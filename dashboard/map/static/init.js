...
function init_control(map){
    var mixed = {
    	"Road Intersections": nodeLayers,
    	"Road Segments": edgeLayers,
        "Wards": wardLayers,
        "Covid Hospitals": hospitalLayers,
        "Test Centers": testcenterLayers,
    };
...
function initMap(mapid){
	...
	httpReqPost('/get_nodes/', {'key':'S0'}, init_nodes);
        httpReqPost('/get_edges/', {'key':'S0'}, init_edges);
	init_control(map);
